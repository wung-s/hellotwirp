...
func NewHelloWorldProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) HelloWorld {
	...
	serviceURL += baseServicePath(clientOpts.PathPrefix(), "twirp.helloworld", "HelloWorld")
	urls := [1]string{
		serviceURL + "Hello",
	}
...
func (c *helloWorldProtobufClient) Hello(ctx context.Context, in *HelloReq) (*HelloResp, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twirp.helloworld")
...
const HelloWorldPathPrefix = "/twirp/twirp.helloworld.HelloWorld/"
...
func (s *helloWorldServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "twirp.helloworld.HelloWorld" {
...
func (s *helloWorldServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "twirp.helloworld", "HelloWorld")
}
...
var twirpFileDescriptor0 = []byte{
	...
	0x4c, 0x4e, 0xd5, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x12, 0x28, 0x29, 0xcf, 0x2c, 0x2a, 0xd0,
	0x43, 0xc8, 0x2b, 0xa9, 0x70, 0x71, 0x78, 0x80, 0x78, 0x41, 0xa9, 0x85, 0x42, 0x12, 0x5c, 0xec,
	0xc5, 0xa5, 0x49, 0x59, 0xa9, 0xc9, 0x25, 0x12, 0x8c, 0x0a, 0x8c, 0x1a, 0x9c, 0x41, 0x30, 0xae,
	0x92, 0x3c, 0x17, 0x27, 0x54, 0x55, 0x71, 0x81, 0x90, 0x10, 0x17, 0x4b, 0x49, 0x6a, 0x05, 0x4c,
	0x0d, 0x98, 0x6d, 0xe4, 0xc7, 0xc5, 0x05, 0x56, 0x10, 0x0e, 0x32, 0x54, 0xc8, 0x81, 0x8b, 0x15,
	0xcc, 0x13, 0x92, 0xd2, 0x43, 0xb7, 0x50, 0x0f, 0x66, 0x9b, 0x94, 0x34, 0x4e, 0xb9, 0xe2, 0x02,
	0x27, 0x81, 0x28, 0x3e, 0x54, 0x8f, 0x24, 0xb1, 0x81, 0x7d, 0x60, 0x0c, 0x08, 0x00, 0x00, 0xff,
	0xff, 0x35, 0xfc, 0x96, 0x0a, 0xe1, 0x00, 0x00, 0x00,
}
